      ...
      <div className="relative w-full max-w-lg max-h-[90vh] overflow-y-auto rounded-t-2xl sm:rounded-2xl bg-white dark:bg-gray-800 shadow-2xl flex flex-col">
        ...
        <div className="flex-1 overflow-y-auto p-4 space-y-4">
          ...
          {mapUrl && (
            <div className="rounded-xl overflow-hidden border border-gray-200 dark:border-gray-700">
              <a
                ...
                className="flex items-center gap-2 p-4 bg-gray-50 dark:bg-gray-700/50 hover:bg-gray-100 dark:hover:bg-gray-700"
              >
                <MapPin className="w-5 h-5 text-primary flex-shrink-0" />
                <div className="min-w-0 flex-1">
                  <p className="font-medium text-dark dark:text-white text-sm">Open in Maps</p>
                  <p className="text-xs text-gray-500 dark:text-gray-400 truncate">{order.address}</p>
                </div>
          ...
          <div className="rounded-xl border border-gray-200 dark:border-gray-700 p-4 space-y-3">
            <p className="font-medium text-dark dark:text-white">Contact</p>
            {order.phone && (
              <p className="text-lg font-mono text-primary">{order.phone}</p>
            )}
            <div className="flex flex-wrap gap-2">
              {callUrl && (
                <a
                  href={callUrl}
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-primary text-white font-medium hover:bg-red-700"
                >
              ...
              {whatsappUrl && (
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-[#25D366] text-white font-medium hover:bg-[#20bd5a]"
                >
              ...
              <button
                ...
                className="inline-flex items-center gap-2 px-4 py-2 rounded-xl bg-primary/10 text-primary font-medium hover:bg-primary/20"
              >
