...
export const SEED_PIZZAS: (SeedProduct & { category: string })[] = [
  ...
  { category: 'HBF Pizzas', name: 'Pickle Achari Pizza', price: 650, description: 'Chicken Achari, Tomatoes, Black Olives, Cheese', size_options: [{ name: 'S-7"', price: 650 }, { name: 'M-10"', price: 1080 }, { name: 'L-14"', price: 1390 }] },
